...
- Before declaring something done, run the test suite (`npm start`). It currently passes 202 checks; if a change drops that count, something regressed.
